...
var ASM_CONSTS = {
 ...
 133536: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 133619: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 133688: () => { return window.innerWidth; },  
 133718: () => { return window.innerHeight; }
};
